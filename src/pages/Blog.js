        ...
        {blogs.map((blog) => (
          <div className="blog-card" key={blog.id}>
            ...
            <div className="blog-content-b">
              ...
              <div className="blog-footer-b">
                <span className="blog-author-b">{blog.author}</span> | <span className="blog-date">{blog.date}</span>
              </div>
              <Link to={`/blog/${blog.id}`} className="blog-button">Read More</Link>
